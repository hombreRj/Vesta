    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args) {
        if (sender instanceof Player) {
            ...
            if (player.hasPermission("scenarios.donator")) {
                ...
                orangeMeta.setLore(Collections.singletonList(ChatColor.translateAlternateColorCodes('&', profile.getPrefix()) + (profile.hasTag() ? ChatColor.translateAlternateColorCodes('&', profile.getTag().getPrefix()) : "") + ChatColor.GOLD + profile.getPlayer().getName()));
                orange.setItemMeta(orangeMeta);
                magentaMeta.setDisplayName(ChatColor.LIGHT_PURPLE + "Magenta Username");
                magentaMeta.setLore(Collections.singletonList(ChatColor.translateAlternateColorCodes('&', profile.getPrefix()) + (profile.hasTag() ? ChatColor.translateAlternateColorCodes('&', profile.getTag().getPrefix()) : "") + ChatColor.LIGHT_PURPLE + profile.getPlayer().getName()));
                magenta.setItemMeta(magentaMeta);
                lightblueMeta.setDisplayName(ChatColor.AQUA + "Light Blue Username");
                lightblueMeta.setLore(Collections.singletonList(ChatColor.translateAlternateColorCodes('&', profile.getPrefix()) + (profile.hasTag() ? ChatColor.translateAlternateColorCodes('&', profile.getTag().getPrefix()) : "") + ChatColor.AQUA + profile.getPlayer().getName()));
                lightblue.setItemMeta(lightblueMeta);
                yellowMeta.setDisplayName(ChatColor.YELLOW + "Yellow Username");
                yellowMeta.setLore(Collections.singletonList(ChatColor.translateAlternateColorCodes('&', profile.getPrefix()) + (profile.hasTag() ? ChatColor.translateAlternateColorCodes('&', profile.getTag().getPrefix()) : "") + ChatColor.YELLOW + profile.getPlayer().getName()));
                yellow.setItemMeta(yellowMeta);
                limegreenMeta.setDisplayName(ChatColor.GREEN + "Light Green Username");
                limegreenMeta.setLore(Collections.singletonList(ChatColor.translateAlternateColorCodes('&', profile.getPrefix()) + (profile.hasTag() ? ChatColor.translateAlternateColorCodes('&', profile.getTag().getPrefix()) : "") + ChatColor.GREEN + profile.getPlayer().getName()));
                limegreen.setItemMeta(limegreenMeta);
                greyMeta.setDisplayName(ChatColor.DARK_GRAY + "Dark Gray Username");
                greyMeta.setLore(Collections.singletonList(ChatColor.translateAlternateColorCodes('&', profile.getPrefix()) + (profile.hasTag() ? ChatColor.translateAlternateColorCodes('&', profile.getTag().getPrefix()) : "") + ChatColor.DARK_GRAY + profile.getPlayer().getName()));
                grey.setItemMeta(greyMeta);
                lightgreyMeta.setDisplayName(ChatColor.GRAY + "Light Gray Username");
                lightgreyMeta.setLore(Collections.singletonList(ChatColor.translateAlternateColorCodes('&', profile.getPrefix()) + (profile.hasTag() ? ChatColor.translateAlternateColorCodes('&', profile.getTag().getPrefix()) : "") + ChatColor.GRAY + profile.getPlayer().getName()));
                lightgrey.setItemMeta(lightgreyMeta);
                cyanMeta.setDisplayName(ChatColor.DARK_AQUA + "Cyan Username");
                cyanMeta.setLore(Collections.singletonList(ChatColor.translateAlternateColorCodes('&', profile.getPrefix()) + (profile.hasTag() ? ChatColor.translateAlternateColorCodes('&', profile.getTag().getPrefix()) : "") + ChatColor.DARK_AQUA + profile.getPlayer().getName()));
                cyan.setItemMeta(cyanMeta);
                purpleMeta.setDisplayName(ChatColor.DARK_PURPLE + "Purple Username");
                purpleMeta.setLore(Collections.singletonList(ChatColor.translateAlternateColorCodes('&', profile.getPrefix()) + (profile.hasTag() ? ChatColor.translateAlternateColorCodes('&', profile.getTag().getPrefix()) : "") + ChatColor.DARK_PURPLE + profile.getPlayer().getName()));
                purple.setItemMeta(purpleMeta);
                darkblueMeta.setDisplayName(ChatColor.DARK_BLUE + "Dark Blue Username");
                darkblueMeta.setLore(Collections.singletonList(ChatColor.translateAlternateColorCodes('&', profile.getPrefix()) + (profile.hasTag() ? ChatColor.translateAlternateColorCodes('&', profile.getTag().getPrefix()) : "") + ChatColor.DARK_BLUE + profile.getPlayer().getName()));
                darkblue.setItemMeta(darkblueMeta);
                greenMeta.setDisplayName(ChatColor.DARK_GREEN + "Dark Green Username");
                greenMeta.setLore(Collections.singletonList(ChatColor.translateAlternateColorCodes('&', profile.getPrefix()) + (profile.hasTag() ? ChatColor.translateAlternateColorCodes('&', profile.getTag().getPrefix()) : "") + ChatColor.DARK_GREEN + profile.getPlayer().getName()));
                green.setItemMeta(greenMeta);
                redMeta.setDisplayName(ChatColor.RED + "Red Username");
                redMeta.setLore(Collections.singletonList(ChatColor.translateAlternateColorCodes('&', profile.getPrefix()) + (profile.hasTag() ? ChatColor.translateAlternateColorCodes('&', profile.getTag().getPrefix()) : "") + ChatColor.RED + profile.getPlayer().getName()));
